  ...
  always_comb
     case(op)                                     // non-R-type instructions
      ...
      `ADDI: controls <= 10'b 1_01_01_00_1_1_0;
       `ANDI: controls <= 10'b 1_01_00_00_1_1_0;
       `XORI: controls <= 10'b 1_01_00_00_1_1_0;                                 
     ...
     `SLTIU: controls <= 10'b 1_01_01_00_1_1_0;
       ...
       `BEQ: controls <= 10'b 0_01_00_00_0_1_0;
       `BNE: controls <= 10'b 0_01_00_00_0_1_0;
         `J: controls <= 10'b 0_00_00_00_0_0_0;
       `JAL: controls <= 10'b 1_00_10_xx_x_x_0;
       // add remaining non-R-type instructions here
      6'b000000:
         case(func)                              // R-type
             `ADD: controls <= 10'b 1_01_00_00_0_0_0; // ADD
             `ADDU: controls <= 10'b 1_01_00_00_0_0_0;
             `SUB: controls <= 10'b 1_01_00_00_0_1_0; // SUB
             ...
             `SLT: controls <= 10'b 1_01_00_00_0_1_0;
